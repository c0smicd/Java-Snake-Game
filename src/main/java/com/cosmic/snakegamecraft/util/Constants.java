...
public class Constants {
    ...
    public static final int IODINE_MAX_COUNT = 2;
    ...
    public static final int FALLOUT_SNAKE_LENGTH = 15;
    public static final int MAX_SNAKE_LENGTH = 400; // Maximum length of the snake
